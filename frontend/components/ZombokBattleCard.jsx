...
const ZombokBattleCard = ({name,level,owner,url,eq1,eq2,id,idtxt}) => {
  ...
  return (
    <div className="zombokcard border border-black rounded-lg shadow-md p-8">
      ...
      <div className="mb-6 border-white">
        <img
          src={url}
          alt="Card Image"
          className="w-full rounded-lg zombokimg"
        />
      </div>
      ...
      {/* Image Stack Section */}
      <div class="invbattle">
        <img src={eq1} alt="Image 1" className="w-full mb-4 zombokeqpimg" />
        <img src={eq2} alt="Image 2" className="w-full mb-4 zombokeqpimg" />
      </div>
    </div>
  );
};

export default ZombokBattleCard;
